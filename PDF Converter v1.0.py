#Please install necessary modules before execute
...
def get_img_func():
        root.img_file_name = tkFileDialog.askopenfilename(initialdir = "/",title = "Select file",filetypes = (("JPG files","*.JPG"),("PNG files","*.PNG"),("all files","*.*")))
...
def convert():
        ...
        root.location = tkFileDialog.asksaveasfilename(initialdir = "/",title = "Select file",filetypes = (("PDF files","*.PDF"),("all files","*.*")))
...
def get_Split_file_func():
        root.get_split_filename = tkFileDialog.askopenfilename(initialdir = "/",title = "Select file",filetypes = (("PDF files","*.PDF"),("all files","*.*")))
...
def get_first_pdf_fn():
        root.first_pdf_file = tkFileDialog.askopenfilename(initialdir = "/",title = "Select file",filetypes = (("PDF files","*.PDF"),("all files","*.*")))
...
def get_second_pdf_fn():
        root.second_pdf_file = tkFileDialog.askopenfilename(initialdir = "/",title = "Select file",filetypes = (("PDF files","*.PDF"),("all files","*.*")))
...
def merge():
        ...
        root.filename = tkFileDialog.asksaveasfilename(initialdir = "/",title = "Select file",filetypes = (("PDF files","*.PDF"),("all files","*.*")))
        print(root.filename)
